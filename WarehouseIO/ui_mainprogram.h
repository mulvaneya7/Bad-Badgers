...
public:
    ...
    void setupUi(QDialog *MainProgram)
    {
        ...
        manualReportCost = new QLineEdit(ReportSales);
        manualReportCost->setObjectName(QStringLiteral("manualReportCost"));
        manualReportCost->setGeometry(QRect(20, 170, 113, 20));
        productSoldLabel = new QLabel(ReportSales);
        productSoldLabel->setObjectName(QStringLiteral("productSoldLabel"));
        ...
        manualReportDate->setGeometry(QRect(20, 320, 110, 22));
