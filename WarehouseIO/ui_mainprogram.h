...
public:
    ...
    QPushButton *getMemberHistory;
    QLineEdit *IDmemberSearchin;
    QLabel *label_2;
    QLineEdit *HistoryTotal;
    QLabel *TotalLabel;
    QLineEdit *NumExecutiveShop;
    QLabel *ofexecutiveLabel;
    QLabel *TransactionListerror;
    QWidget *MemberList;
    ...
    void setupUi(QDialog *MainProgram)
    {
        ...
        TransactionTable->setGeometry(QRect(41, 20, 721, 341));
        ...
        reportPrompt->setGeometry(QRect(500, 360, 141, 16));
        ...
        Expirationoutput->setGeometry(QRect(40, 380, 451, 91));
        ...
        PrintTransaction->setGeometry(QRect(590, 450, 181, 21));
        getMemberHistory = new QPushButton(Transaction);
        getMemberHistory->setObjectName(QStringLiteral("getMemberHistory"));
        getMemberHistory->setGeometry(QRect(640, 420, 131, 23));
        IDmemberSearchin = new QLineEdit(Transaction);
        IDmemberSearchin->setObjectName(QStringLiteral("IDmemberSearchin"));
        IDmemberSearchin->setGeometry(QRect(510, 420, 113, 20));
        label_2 = new QLabel(Transaction);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(510, 400, 141, 16));
        HistoryTotal = new QLineEdit(Transaction);
        HistoryTotal->setObjectName(QStringLiteral("HistoryTotal"));
        HistoryTotal->setGeometry(QRect(40, 500, 113, 20));
        TotalLabel = new QLabel(Transaction);
        TotalLabel->setObjectName(QStringLiteral("TotalLabel"));
        TotalLabel->setGeometry(QRect(40, 480, 111, 16));
        NumExecutiveShop = new QLineEdit(Transaction);
        NumExecutiveShop->setObjectName(QStringLiteral("NumExecutiveShop"));
        NumExecutiveShop->setGeometry(QRect(180, 500, 113, 20));
        ofexecutiveLabel = new QLabel(Transaction);
        ofexecutiveLabel->setObjectName(QStringLiteral("ofexecutiveLabel"));
        ofexecutiveLabel->setGeometry(QRect(180, 480, 181, 16));
        TransactionListerror = new QLabel(Transaction);
        TransactionListerror->setObjectName(QStringLiteral("TransactionListerror"));
        TransactionListerror->setGeometry(QRect(640, 360, 121, 16));
        ...
        pushButton_3->setGeometry(QRect(600, 480, 171, 23));
        ...
        SaveButton->setGeometry(QRect(440, 480, 141, 23));
        ...
        ItemStatstable->setGeometry(QRect(100, 50, 601, 291));
        ...
        itemAvailabilitLabel->setGeometry(QRect(10, 470, 281, 16));
        addItemCheckLabel = new QLabel(ItemInfo);
        addItemCheckLabel->setObjectName(QStringLiteral("addItemCheckLabel"));
        addItemCheckLabel->setGeometry(QRect(410, 480, 271, 16));
        ...
        MemberDataTable->setGeometry(QRect(10, 150, 371, 271));
        ...
        AddMember->setGeometry(QRect(610, 220, 151, 23));
        ...
        ChangeMemberShip->setGeometry(QRect(60, 440, 241, 23));
        line_4 = new QFrame(SearchMember);
        line_4->setObjectName(QStringLiteral("line_4"));
        line_4->setGeometry(QRect(410, 0, 20, 521));
        line_4->setFrameShape(QFrame::VLine);
        line_4->setFrameShadow(QFrame::Sunken);
        line_5 = new QFrame(SearchMember);
        line_5->setObjectName(QStringLiteral("line_5"));
        line_5->setGeometry(QRect(430, 260, 371, 20));
        ...
        line->setGeometry(QRect(400, 40, 20, 491));
        line->setFrameShape(QFrame::VLine);
        line->setFrameShadow(QFrame::Sunken);
        line_2 = new QFrame(ReportSales);
        line_2->setObjectName(QStringLiteral("line_2"));
        line_2->setGeometry(QRect(0, 40, 791, 20));
        ...
        RepoerfileFile->setGeometry(QRect(426, 60, 171, 16));
        line_3 = new QFrame(ReportSales);
        line_3->setObjectName(QStringLiteral("line_3"));
        line_3->setGeometry(QRect(-3, 80, 801, 20));
    ...
    void retranslateUi(QDialog *MainProgram)
    {
        ...
        GenerateReport->setText(QApplication::translate("MainProgram", "Get Daily Report", Q_NULLPTR));
        ...
        getMemberHistory->setText(QApplication::translate("MainProgram", "Get Member History", Q_NULLPTR));
        label_2->setText(QApplication::translate("MainProgram", "I.D. of the member", Q_NULLPTR));
        TotalLabel->setText(QApplication::translate("MainProgram", "Total($)", Q_NULLPTR));
        ofexecutiveLabel->setText(QApplication::translate("MainProgram", "# of Executive level shoppers", Q_NULLPTR));
        TransactionListerror->setText(QString());
